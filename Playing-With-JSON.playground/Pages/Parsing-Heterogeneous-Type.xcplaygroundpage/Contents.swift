...
// ex: postcode on occasion is an Int os a String
...
enum AppError: Error {
    case missingValue // if not an Int or a String throw this error
}
...
enum Postcode: Decodable {
    ...
    // override the init(from decoder:) intializer
    
    init(from decoder: Decoder) throws {
        // handle two cases of Int or Strijn
        
        // if it's not an Int or a String than we will throw an error
